...
public class Blob implements Serializable {
    private String sourceFileName; // The source file name to generate a Blob
    private byte[] content; // Blob's content
    private String id; // Blob's SHA1 value, calculate by sha1(filename, content)
